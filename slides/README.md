...
`session1/01-session1-fundamentals.pptx` (48 slides).
...
| 18:50 testing vs. verification | 16–23 | V&V, why testing can't prove absence, soundness/completeness, **techniques as real tools** (Coverity/KLEE/Astrée/CBMC/Dafny by method), sound × complete grid, technique landscape, **the negation trick** |
| 19:15 break | 24 | — |
| 19:25 SAT and SMT | 25–31 | SAT, sat/unsat as witness/proof, SMT theories for C, array-bounds worked example, live `z3_demo.py`, wrap-around, SEND+MORE=MONEY |
| 19:50 bounded model checking | 32–41 | pipeline, loop unwinding, **`--unwind k` verdict table**, SSA, **counterexample anatomy**, live `offbyone.c` demo, nondet/assume/assert preview, concurrency + floating-point hooks for Lab 4 |
| 20:15 Exercise 2 | 42 | predict the verdict |
| 20:30 industry landscape + discussion | 43–46 | AWS/SV-COMP, KLEE/SAGE/OSS-Fuzz, Astrée/seL4/CompCert, discussion |
| 20:50 quiz + setup homework | 47–48 | closing quiz, Session 2 setup |
