...
`session1/01-session1-fundamentals.pptx` (47 slides).
...
| 18:50 testing vs. verification | 16–22 | V&V, why testing can't prove absence, soundness/completeness, sound × complete grid, technique landscape, **the negation trick** |
| 19:15 break | 23 | — |
| 19:25 SAT and SMT | 24–30 | SAT, sat/unsat as witness/proof, SMT theories for C, array-bounds worked example, live `z3_demo.py`, wrap-around, SEND+MORE=MONEY |
| 19:50 bounded model checking | 31–40 | pipeline, loop unwinding, **`--unwind k` verdict table**, SSA, **counterexample anatomy**, live `offbyone.c` demo, nondet/assume/assert preview, concurrency + floating-point hooks for Lab 4 |
| 20:15 Exercise 2 | 41 | predict the verdict |
| 20:30 industry landscape + discussion | 42–45 | AWS/SV-COMP, KLEE/SAGE/OSS-Fuzz, Astrée/seL4/CompCert, discussion |
| 20:50 quiz + setup homework | 46–47 | closing quiz, Session 2 setup |
